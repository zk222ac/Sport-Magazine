...
namespace SportzMagazine.Views
{
    ...
    /// </summary>
    public sealed partial class LoginInfo : Page
    {
        public LoginInfo()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            name.Text = passedParameter.App1.Name.ToString();
            address.Text = passedParameter.App1.Address.ToString();
            email.Text = passedParameter.App1.Email.ToString();
            phone.Text = passedParameter.App1.Phone.ToString();
